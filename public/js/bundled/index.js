...
var _mapboxJs = require("../js/mapbox.js");
...
},{"@babel/polyfill":"dTCHC","../js/mapbox.js":"3zDlz","./login.js":"7yHem","./updateSettings.js":"l3cGY","./stripe.js":"10tSC"}],"dTCHC":[function(require,module,exports) {
"use strict";
require("./noConflict");
...
const updateSettings = async (data, type)=>{
    try {
        const url = type === "password" ? "http://localhost:7000/api/v1/auth/updatepassword" : "http://localhost:7000/api/v1/auth/updatemyinfo";
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url,
            data
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alertsJs = require("./alerts.js");
const stripe = Stripe("pk_test_51LN39zCRZVXV9ebKTVNEOY9lUYxCfQS0xpp4fEBHxit58QnKe2SRta7RH5RjuPTtwmP2cSt7Vw5G7ttcQlpGqKUb00Aev0SnyH");
const bookTour = async (tourId)=>{
    //! 1) Get checkout session from API.
    const session = await (0, _axiosDefault.default)(`http://localhost:7000/api/v1/bookings/checkout-session/${tourId}`);
    console.log(session);
...
},{"axios":"jo6P5","./alerts.js":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4V44L","f2QDv"], "f2QDv", "parcelRequire4c92")
